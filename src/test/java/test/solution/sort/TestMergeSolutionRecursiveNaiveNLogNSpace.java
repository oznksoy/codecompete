...
public class TestMergeSolutionRecursiveNaiveNLogNSpace {

	@Test
	public void test() {
		runRandomizedTestCase(SortSolutionType.MERGE_RECURSIVE_NLOGN_SPACE);
	}

	@Test
	public void testHalfInOrderatRandom() {

		testHalfInOrderatRandom(SortSolutionType.MERGE_RECURSIVE_NLOGN_SPACE);
	...
	public void testOneToFiveCase() {
		...
		testOneToFiveCase(SortSolutionType.MERGE_RECURSIVE_NLOGN_SPACE);
	...
	public void testBestCase() {
		...
		testBestCase(SortSolutionType.MERGE_RECURSIVE_NLOGN_SPACE);
	...
	public void testWorstCase() {
		...
		testWorstCase(SortSolutionType.MERGE_RECURSIVE_NLOGN_SPACE);
