...
public class TestMergeSolutionRecursiveNLogNSpaceDivisionOnMerge extends AbstSortSolutionTest {
	...
	public void setSolutionTypeToTest() {
		solutionType = SortSolutionType.MERGE_RECURSIVE_NLOGN_SPACE_DIVISION_ON_MERGE;
	}
