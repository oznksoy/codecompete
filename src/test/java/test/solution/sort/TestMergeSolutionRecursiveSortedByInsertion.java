...
public class TestMergeSolutionRecursiveSortedByInsertion extends AbstSortSolutionTest {
	...
	public void setSolutionTypeToTest() {
		solutionType = SortSolutionType.MERGE_RECURSIVE_SORTED_BY_INSERTION;
	}
